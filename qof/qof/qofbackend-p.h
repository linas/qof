...
-# if the backend recognises the type as one that it can load and
write or 
...
function is typically called by the provider library at library
load time. This function allows the backend library to tell
QOF infrastructure that it can handle URL's of a certain type.
