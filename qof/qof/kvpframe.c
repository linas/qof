...
void
kvp_frame_set_string (KvpFrame * frame, const gchar *path, const char *str)
{
	KvpValue *value;
...
void
kvp_frame_set_guid (KvpFrame * frame, const gchar *path, const GUID * guid)
{
	KvpValue *value;
...
gint
double_compare (gdouble d1, gdouble d2)
{
