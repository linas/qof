...
void vsuccess_args (const char *test_title,
					const char *file,
					int line, const char *format, va_list ap);

void vfailure_args (const char *test_title,
					const char *file,
					int line, const char *format, va_list ap);
...
void
success_call (const char *test_title, const char *file, int line)
{
	success_args (test_title, file, line, "");
}

void
success_args (const char *test_title,
...
void
vsuccess_args (const char *test_title,
...
void
failure_call (const char *test_title, const char *file, int line)
{
...
void
failure_args (const char *test_title,
			  const char *file, int line, const char *format, ...)
{
	va_list ap;
	va_start (ap, format);
...
void
vfailure_args (const char *test_title,
			   const char *file, int line, const char *format, va_list ap)
{
...
gboolean
do_test_call (gboolean result,
			  const char *test_title, const char *filename, int line)
{
	if (result)
	{
